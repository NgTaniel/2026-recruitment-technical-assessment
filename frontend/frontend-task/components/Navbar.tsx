  ...
  return (
    <div>
      <div className='flex border-b border-gray-300 justify-between items-center'>
        {/* left side */}
        <div className='flex pt-1 px-1.5 pb-2.5 w-full ml-2 justify-start rounded-sm'>
          <img src={freeroomsIcon} alt="freerooms logo" className='w-1/30 text-black'/>
          <h1 className='font-josefin text-3xl pt-1 text-[#ed6d00] font-semibold'>Freerooms</h1>
        </div>

        {/* Right side */}
        <div className='flex justify-center items-center gap-2 mr-4'>
          <div className='border border-[#ed6d00] p-2 h-7/8 rounded-sm'>
            <img src={searchIcon} alt="search logo" className='w-6.5 text-black'/>
          </div>
          <div className='border border-[#ed6d00] bg-[#ed6d00] p-2 h-7/8 rounded-sm'>
            <img src={gridIcon} alt="grid logo" className='w-6.5 text-black'/>
          </div>
          <div className='border border-[#ed6d00] p-2 h-7/8 rounded-sm'>
            <img src={mapIcon} alt="map logo" className='w-6.5 text-black'/>
          </div>
          <div className='border border-[#ed6d00] p-2 h-7/8 rounded-sm'>
            <img src={darkIcon} alt="dark mode logo" className='w-6.5 text-black'/>
          </div>
        </div>
      </div>
    </div>
