  ...
  return (
    <div>
      <div className="flex border-b border-gray-300 justify-between items-center">
        {/* left side */}
        <div className="flex px-1.5 w-full ml-2 mt-1.5 mb-2 justify-start rounded-sm sm:w-1/4 lg:w-1/8">
          <img src={doorToggle} onClick={() => doorButtonHandle()} alt="freerooms logo" className="cursor-pointer w-1/5 sm:w-1/4 text-black"/>
          <h1 className="font-['Josefin_Sans'] text-3xl pt-1.75 text-[#ed6d00] font-semibold sm:block hidden">Freerooms</h1>
        </div>
